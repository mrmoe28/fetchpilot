...
export const metadata: Metadata = {
  title: 'Sign In',
  description: 'Sign in to FetchPilot to access your scraping jobs and history',
}
          ...
          <div className="flex flex-col items-center text-center gap-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-fetchpilot-text mb-2">
                Welcome to FetchPilot
              </h1>
              <p className="text-slate-600">
                Sign in to access your scraping dashboard and job history
              </p>
            </div>
            ...
            <div className="w-full space-y-3">
              ...
              >
                <Button type="submit" className="w-full bg-white hover:bg-slate-50 text-slate-900 border border-slate-200">
